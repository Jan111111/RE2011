    ...
    public static void main(String[] args) {
        /*
            ...
            2：使用SAXReader读取xml文档并生成Document对象
               这一步也是DMO解析耗时耗资源的地方，因为是先读取整个XML文档并内建完整的树结构到
               Decument对象中保存
            3：通过Document对象来获取元素
        ...
        try{
            ...
            //3获取根标签
            /*
                Element的每一个实例用于表现XML文档中的每一个元素（一对标签）
            ...
            for(Element empEle:list){
                ...
                /*
                    ...
                    该方法可以获取当前标签下指定名字的子标签中间的文本，等同上面操作
                 */
                ...
                //获取<emp>的id属性
//                Attribute attribute =empEle.attribute("id");
//                int id=Integer.parseInt(attribute.getValue());
//                System.out.println(id);

                int id=Integer.parseInt(empEle.attributeValue("id"));
                System.out.println(id+","+ename+","+egender+","+eage+","+esalary);
